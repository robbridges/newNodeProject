...
var updateUserAndReturnCount = function (id, age) { return __awaiter(void 0, void 0, void 0, function () {
    var user, count;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, user_1.default.findByIdAndUpdate(id, { age: age })];
            case 1:
                user = _a.sent();
                return [4 /*yield*/, user_1.default.countDocuments({ age: age })];
            case 2:
                count = _a.sent();
...
updateUserAndReturnCount('6152a10a1cb015f3194e921a', 23).then(function (count) {
    console.log(count);
}).catch(function (e) {
    console.log(e);
});
